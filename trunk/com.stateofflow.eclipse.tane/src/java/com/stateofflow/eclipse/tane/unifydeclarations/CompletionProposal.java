...
public class CompletionProposal implements IJavaCompletionProposal {
    ...
    public void apply(IDocument document) {
        openRefactoringWizard(createRefactoringWizard(document, new UnifyDeclarationsRefactoring(document, node, fragments)));
    }
    ...
    private RefactoringWizard createRefactoringWizard(final IDocument document, final UnifyDeclarationsRefactoring refactoring) {
