...
public class IncreaseScopeRefactoring extends Refactoring {
    private final IDocument document;
    private Statement node;
    private final List<VariableDeclarationFragment> fragments;

    public IncreaseScopeRefactoring(IDocument document, Statement node, List<VariableDeclarationFragment> fragments) {
    ...
    private Change createChange(ASTRewrite rewrite) {
        DocumentChange documentChange = new DocumentChange("Increase Scope", document);
